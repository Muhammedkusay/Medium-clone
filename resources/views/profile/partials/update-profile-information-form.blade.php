<section>
    ...
    {{-- show avatar --}}
    <x-user-avatar :user="$user" class="w-32 h-32 md:w-36 md:h-36 mt-8 mx-auto md:mx-0"/>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        {{-- Avatar --}}
        <div class="mb-4">
            <x-input-label for="image" :value="__('Avatar')" class="mb-1"/>
        ...
        <div class="mb-4">
            ...
            <x-textarea id="bio" class="block mt-1 w-full" name="bio" autocomplete="bio">{{ old('bio', $user->bio) }}</x-textarea>
